  ...
  <section class="row">
    <div class="container">
      <div class="col-sm-8">
        ...
        <ul>
          <li>Your customers will know when to expect us making it easier to plan their day</li>
          <li>Your customers will receive goods at a time convenient to them thanks to our
        ...
        <p class="small">*Standard email notifications are free of charge. SMS text messages will incur a small additional charge.</p>
        <br/>
        <h6>How does it work?</h6>
